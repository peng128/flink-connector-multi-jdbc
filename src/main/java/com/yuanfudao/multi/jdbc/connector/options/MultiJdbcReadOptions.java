...
public class MultiJdbcReadOptions implements Serializable {
    ...
    public boolean equals(Object o) {
        if (o instanceof MultiJdbcReadOptions) {
            MultiJdbcReadOptions options = (MultiJdbcReadOptions) o;
            return Objects.equals(query, options.query)
                    ...
                    && Objects.equals(batchSize, options.batchSize)
    ...
    /** Builder of {@link MultiJdbcReadOptions}. */
    public static class Builder {
        ...
        /**
         * optional, the number of rows to one batch. default value is 0, according to the jdbc api,
         * 0 means that batchSize hint will be ignored.
         */
        ...
        public MultiJdbcReadOptions build() {
            return new MultiJdbcReadOptions(
                    query,
                    partitionColumnName,
                    partitionLowerBound,
                    partitionUpperBound,
